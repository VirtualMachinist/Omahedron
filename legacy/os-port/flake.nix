{
  description = "ARCHIVED: Omahedron NixOS desktop port pinned to Omarchy v4.0.3 (ADR-0027). Not the product. See the repository root.";
        ...
        in
        {
          ...
          omarchy-skill =
            ...
            pkgs.runCommand "omarchy-skill-check" { nativeBuildInputs = [ pkgs.jq ]; } ''
              ...
              touch "$out"
            '';
          # Runtime Nix skill pack (rebuild/flake/module/forensics/compat/pins).
