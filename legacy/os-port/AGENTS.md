...
> **Archived.** This manual belongs to the NixOS desktop port retired by [ADR-0027](../../DECISIONS.md) (2026-09-21). The product at the repository root is the Hedron theme pack. Current manual: [../../AGENTS.md](../../AGENTS.md).

Operating manual for the archived NixOS port. Do not treat it as the current product.
